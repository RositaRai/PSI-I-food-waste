...
namespace FoodWasteTests
{
    public class ProductModelTests
    {
        ...
        public void Product_CompareTo_ShoulReturnFalse()
        {
            ...
            var product2 = new Product { PrID = Guid.NewGuid(), RestId = Guid.NewGuid(), Name = "product2", Size = ProductSize.Small, IsGlutenFree = false, Price = 10, DiscountedPrice = 5, Discount = 50 };
            int expected = 0;
            //Act
